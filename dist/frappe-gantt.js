			...
			try {
				for (var _iterator7 = self.dates[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
					...
					if (date.isoWeekday() === 6 || date.isoWeekday() === 7) {
						self.canvas.rect(x, y, width, height).addClass('grid-weekend').appendTo(self.element_groups.grid);
					}
		...
		function get_dates_to_draw() {
			...
			var dates = self.dates.map(function (date, i) {
				...
				if (view_is('Day') && d.upper_text && d.lower_text !== '1') {
					var daysMonth = date.daysInMonth() - d.lower_text + 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Bar(gt, task) {
		...
		function compute_start_end_date() {
			var bar = self.$bar;
			var x_in_units = (bar.getX() - gt.config.left_menu_width) / gt.config.column_width;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".gantt .grid-background {\n  fill: none; }\n\n.gantt .grid-header {\n  fill: #ffffff;\n  stroke: #e0e0e0;\n  stroke-width: 1.4; }\n\n.gantt .grid-row {\n  fill: #ffffff; }\n\n.gantt .grid-row:nth-child(even) {\n  fill: #f5f5f5; }\n\n.gantt .grid-weekend {\n  fill: #fdfdfd; }\n\n.gantt .row-line {\n  stroke: #ebeff2; }\n\n.gantt .row-line-project {\n  stroke: #e0e0e0;\n  stroke-width: 1.4; }\n\n.gantt .tick {\n  stroke: #e0e0e0;\n  stroke-width: 0.6; }\n  .gantt .tick.thick {\n    stroke-width: 0.8; }\n\n.gantt .tick-today, .gantt .tick-current, .gantt .tick-current-late {\n  stroke-width: 1;\n  opacity: 0.8;\n  stroke-dasharray: 7; }\n\n.gantt .tick-today {\n  stroke: #43a047; }\n\n.gantt .tick-current {\n  stroke: #82b1f3; }\n\n.gantt .tick-current-late {\n  stroke: #f1aa9e; }\n\n.gantt .today-highlight, .gantt .current-highlight, .gantt .current-highlight-late {\n  opacity: 0.5; }\n\n.gantt .today-highlight {\n  fill: #b9f3b9; }\n\n.gantt .current-highlight {\n  fill: #82b1f3; }\n\n.gantt .current-highlight-late {\n  fill: #f1aa9e; }\n\n.gantt #arrow {\n  fill: none;\n  stroke: #666;\n  stroke-width: 1.4; }\n\n.gantt .bar {\n  fill: #1976d2;\n  stroke: #1976d2;\n  stroke-width: 0;\n  transition: stroke-width .3s ease; }\n\n.gantt .group-bar .bar {\n  fill: #03396f !important; }\n\n.gantt .projection-bar .bar {\n  fill: #f1b4a9 !important;\n  stroke: tomato;\n  stroke-width: 0.8;\n  opacity: 0.8; }\n\n.gantt .group-bar-progress {\n  fill: #16611a !important; }\n\n.gantt .bar-progress {\n  fill: #43a047; }\n\n.gantt .bar-invalid {\n  fill: transparent;\n  stroke: #1976d2;\n  stroke-width: 1;\n  stroke-dasharray: 5; }\n  .gantt .bar-invalid ~ .bar-label {\n    fill: #555; }\n\n.gantt .bar-label {\n  fill: #fff;\n  dominant-baseline: central;\n  text-anchor: middle;\n  font-size: 12px;\n  letter-spacing: 0.8px; }\n  .gantt .bar-label.big {\n    fill: #555;\n    text-anchor: start; }\n\n.gantt .handle {\n  fill: #ddd;\n  cursor: ew-resize;\n  opacity: 0;\n  visibility: hidden;\n  transition: opacity .3s ease; }\n\n.gantt .bar-wrapper {\n  cursor: pointer; }\n  .gantt .bar-wrapper:hover .bar {\n    stroke-width: 2; }\n  .gantt .bar-wrapper:hover .handle {\n    visibility: visible;\n    opacity: 1; }\n  .gantt .bar-wrapper.active .bar {\n    stroke-width: 2; }\n\n.gantt .lower-text, .gantt .upper-text {\n  font-size: 12px;\n  text-anchor: middle; }\n\n.gantt .upper-text {\n  fill: #555; }\n\n.gantt .lower-text {\n  fill: #333; }\n\n.gantt .project-text-container {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #555; }\n\n.gantt .project-text {\n  text-align: center; }\n\n.gantt #details .details-container {\n  background: #fff;\n  display: inline-block;\n  padding: 12px; }\n  .gantt #details .details-container h5, .gantt #details .details-container p {\n    margin: 0;\n    line-height: 1.2;\n    font-size: 12px; }\n  .gantt #details .details-container h5 {\n    font-weight: bold;\n    margin-bottom: 10px;\n    color: #555; }\n  .gantt #details .details-container p {\n    margin-bottom: 6px;\n    color: #666; }\n  .gantt #details .details-container p:last-child {\n    margin-bottom: 0; }\n\n.gantt .hide {\n  display: none; }\n\n.gantt .grid-project-row {\n  fill: #f5f5f5; }\n\n.gantt .avatarContainer {\n  height: 64px;\n  display: flex;\n  align-items: center;\n  padding-right: 10px;\n  float: left; }\n\n.gantt .avatar {\n  height: 50px !important; }\n\n.gantt .external-user .bar {\n  fill: #747474; }\n", "", {"version":3,"sources":["/home/f4103757/workspace/gantt/src/src/gantt.scss"],"names":[],"mappings":"AA0BA;EAGE,WAAU,EACV;;AAJF;EAME,cAAa;EACb,gBA9BoB;EA+BpB,kBAAiB,EACjB;;AATF;EAWE,cAAa,EACb;;AAZF;EAcE,cApCgB,EAqChB;;AAfF;EAiBE,cAhCkB,EAiClB;;AAlBF;EAoBE,gBAzC0B,EA0C1B;;AArBF;EAuBE,gBA9CoB;EA+CpB,kBAAiB,EACjB;;AAzBF;EA2BE,gBAlDoB;EAmDpB,kBAAiB,EAIjB;EAhCF;IA8BG,kBAAiB,EACjB;;AA/BH;EAmCE,gBAAe;EACf,aAAY;EACZ,oBAAmB,EACnB;;AAtCF;EAyCE,gBAjDa,EAkDb;;AA1CF;EA6CE,gBAzDkB,EA2DlB;;AA/CF;EAiDE,gBA5DiB,EA6DjB;;AAlDF;EAqDE,aAAY,EACZ;;AAtDF;EAyDE,cAhEmB,EAiEnB;;AA1DF;EA6DE,cAzEkB,EA0ElB;;AA9DF;EAiEE,cA5EiB,EA6EjB;;AAlEF;EAqEE,WAAU;EACV,aAzFe;EA0Ff,kBAAiB,EACjB;;AAxEF;EA2EE,cApGiB;EAqGjB,gBApGkB;EAqGlB,gBAAe;EACf,kCAAiC,EACjC;;AA/EF;EAkFE,yBAA2B,EAC3B;;AAnFF;EAsFE,yBAAwB;EACxB,eAAc;EAEd,kBAAiB;EACjB,aAAY,EACZ;;AA3FF;EA8FE,yBAA4B,EAC5B;;AA/FF;EAkGE,cA1Ga,EA2Gb;;AAnGF;EAsGE,kBAAiB;EACjB,gBA/HkB;EAgIlB,gBAAe;EACf,oBAAmB,EAKnB;EA9GF;IA4GG,WA9Hc,EA+Hd;;AA7GH;EAgHE,WAAU;EACV,2BAA0B;EAC1B,oBAAmB;EACnB,gBAAe;EAEf,sBAAqB,EAMrB;EA3HF;IAwHG,WA1Ic;IA2Id,mBAAkB,EAClB;;AA1HH;EA8HE,WAlJiB;EAmJjB,kBAAiB;EACjB,WAAU;EACV,mBAAkB;EAClB,6BAA4B,EAC5B;;AAnIF;EAsIE,gBAAe,EAkBf;EAxJF;IA0II,gBAAe,EACf;EA3IJ;IA8II,oBAAmB;IACnB,WAAU,EACV;EAhJJ;IAqJI,gBAAe,EACf;;AAtJJ;EA2JE,gBAAe;EACf,oBAAmB,EACnB;;AA7JF;EA+JE,WAjLe,EAkLf;;AAhKF;EAkKE,WAnLe,EAoLf;;AAnKF;EAqKE,cAAa;EACb,oBAAmB;EACnB,wBAAuB;EACvB,YA1Le,EA2Lf;;AAzKF;EA2KE,mBAAkB,EAClB;;AA5KF;EA+KE,iBAAgB;EAChB,sBAAqB;EACrB,cAAa,EAsBb;EAvMF;IAoLG,UAAS;IACT,iBAAgB;IAChB,gBAAe,EACf;EAvLH;IA0LG,kBAAiB;IACjB,oBAAmB;IACnB,YA9Mc,EA+Md;EA7LH;IAgMG,mBAAkB;IAClB,YApNc,EAqNd;EAlMH;IAqMG,iBAAgB,EAChB;;AAtMH;EA0ME,cAAa,EACb;;AA3MF;EA8ME,cApOgB,EAqOhB;;AA/MF;EAkNE,aAAY;EACZ,cAAa;EACb,oBAAmB;EACnB,oBAAmB;EACnB,YAAW,EAEX;;AAxNF;EA0NE,wBAAuB,EACvB;;AA3NF;EA8NE,cAAa,EACb","file":"gantt.scss","sourcesContent":["// $bar-color: #b8c2cc;\n$bar-color: #1976d2;\n$bar-stroke: #1976d2;\n$border-color: #e0e0e0;\n$light-bg: #f5f5f5;\n$light-border-color: #ebeff2;\n$handle-color: #ddd;\n$text-muted: #666;\n$text-light: #555;\n$text-color: #333;\n$grey: #b8c2cc;\n$light-grey: #fdfdfd;\n$dark-blue: #03396f;\n$blue: #3887f3;\n$light-blue: #82b1f3;\n$light-red: #f1aa9e;\n$light-yellow: #fcf8e3;\n$dark-green: #16611a;\n$green: #43a047;\n$light-green: #b9f3b9;\n\n\n// body {\n//   font-family: sans-serif; \n// }\n\n.gantt {\n\n\t.grid-background {\n\t\tfill: none;\n\t}\n\t.grid-header {\n\t\tfill: #ffffff;\n\t\tstroke: $border-color;\n\t\tstroke-width: 1.4;\n\t}\n\t.grid-row {\n\t\tfill: #ffffff;\n\t}\n\t.grid-row:nth-child(even) {\n\t\tfill: $light-bg;\n\t}\n\t.grid-weekend {\n\t\tfill: $light-grey;\n\t}\n\t.row-line {\n\t\tstroke: $light-border-color;\t\t\n\t}\n\t.row-line-project {\t\t\n\t\tstroke: $border-color;\t\t\n\t\tstroke-width: 1.4;\n\t}\n\t.tick {\n\t\tstroke: $border-color;\n\t\tstroke-width: 0.6;\n\t\t&.thick {\n\t\t\tstroke-width: 0.8;\n\t\t}\n\t}\n\n\t.tick-today, .tick-current, .tick-current-late {\t\t\n\t\tstroke-width: 1;\t\n\t\topacity: 0.8;\t\n\t\tstroke-dasharray: 7;\n\t}\n\n\t.tick-today {\n\t\tstroke: $green;\t\t\n\t}\n\n\t.tick-current {\n\t\tstroke: $light-blue;\n\t\t\n\t}\n\t.tick-current-late {\n\t\tstroke: $light-red;\n\t}\n\n\t.today-highlight, .current-highlight, .current-highlight-late{\n\t\topacity: 0.5;\n\t}\n\n\t.today-highlight {\n\t\tfill: $light-green;\t\t\n\t}\n\n\t.current-highlight {\n\t\tfill: $light-blue;\n\t}\n\n\t.current-highlight-late {\n\t\tfill: $light-red;\n\t}\n\n\t#arrow {\n\t\tfill: none;\n\t\tstroke: $text-muted;\n\t\tstroke-width: 1.4;\n\t}\n\n\t.bar {\n\t\tfill: $bar-color;\n\t\tstroke: $bar-stroke;\n\t\tstroke-width: 0;\n\t\ttransition: stroke-width .3s ease;\n\t}\n\n\t.group-bar .bar {\n\t\tfill: $dark-blue !important;\t\t\n\t}\n\n\t.projection-bar .bar {\t\n\t\tfill: #f1b4a9 !important;\n\t\tstroke: tomato;\n\t\t// stroke-dasharray: 7;\n\t\tstroke-width: 0.8;\n\t\topacity: 0.8;\n\t}\t\n\n\t.group-bar-progress{\n\t\tfill: $dark-green !important;\n\t}\n\n\t.bar-progress {\n\t\tfill: $green;\n\t}\n\n\t.bar-invalid {\n\t\tfill: transparent;\n\t\tstroke: $bar-stroke;\n\t\tstroke-width: 1;\n\t\tstroke-dasharray: 5;\n\n\t\t&~.bar-label {\n\t\t\tfill: $text-light;\n\t\t}\n\t}\n\t.bar-label {\n\t\tfill: #fff;\n\t\tdominant-baseline: central;\n\t\ttext-anchor: middle;\n\t\tfont-size: 12px;\n\t\t// font-weight: lighter;\n\t\tletter-spacing: 0.8px;\n\n\t\t&.big {\n\t\t\tfill: $text-light;\n\t\t\ttext-anchor: start;\n\t\t}\n\t}\n\n\t.handle {\n\t\tfill: $handle-color;\n\t\tcursor: ew-resize;\n\t\topacity: 0;\n\t\tvisibility: hidden;\n\t\ttransition: opacity .3s ease;\n\t}\n\n\t.bar-wrapper {\n\t\tcursor: pointer;\n\n\t\t&:hover {\n\t\t\t.bar {\n\t\t\t\tstroke-width: 2;\n\t\t\t}\n\n\t\t\t.handle {\n\t\t\t\tvisibility: visible;\n\t\t\t\topacity: 1;\n\t\t\t}\n\t\t}\n\n\t\t&.active {\n\t\t\t.bar {\n\t\t\t\tstroke-width: 2;\n\t\t\t}\n\t\t}\n\t}\n\n\t.lower-text, .upper-text {\n\t\tfont-size: 12px;\n\t\ttext-anchor: middle;\n\t}\n\t.upper-text {\n\t\tfill: $text-light;\n\t}\n\t.lower-text {\n\t\tfill: $text-color;\n\t}\n\t.project-text-container{\t\t\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t\tjustify-content: center;\n\t\tcolor: $text-light;\t\t\n\t}\n\t.project-text{\n\t\ttext-align: center;\t\t\n\t}\n\n\t#details .details-container {\n\t\tbackground: #fff;\n\t\tdisplay: inline-block;\n\t\tpadding: 12px;\t\t\n\t\t\n\t\th5, p {\n\t\t\tmargin: 0;\n\t\t\tline-height: 1.2;\n\t\t\tfont-size: 12px;\n\t\t}\n\n\t\th5 {\t\t\t\n\t\t\tfont-weight: bold;\n\t\t\tmargin-bottom: 10px;\n\t\t\tcolor: $text-light;\n\t\t}\n\n\t\tp {\t\t\t\n\t\t\tmargin-bottom: 6px;\n\t\t\tcolor: $text-muted;\n\t\t}\n\n\t\tp:last-child {\n\t\t\tmargin-bottom: 0;\n\t\t}\n\t}\n\n\t.hide {\n\t\tdisplay: none;\n\t}\n\n\t.grid-project-row {\n\t\tfill: $light-bg;\n\t}\n\n\t.avatarContainer{\n\t\theight: 64px;\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t\tpadding-right: 10px;\n\t\tfloat: left;\n\t\t\n\t}\n\t.avatar{\n\t\theight: 50px !important;\n\t}\n\n\t.external-user .bar{\n\t\tfill: #747474;\n\t}\n}\n\n"],"sourceRoot":""}]);
